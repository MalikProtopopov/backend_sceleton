...
from app.modules.content_blocks.models import ContentBlock
...
class ContentBlockService:
    ...
    to articles, cases, services, employees, and products.
    """
    ...
    async def list_blocks(
        ...
        """List content blocks for an entity, ordered by sort_order."""
        stmt = (
            select(ContentBlock)
